        ...
        return (
            ...
            <div className="content-wrapper">
                ...
                <div className="inline split-right">
                    <img src={require("../images/NWNToolset/Lag Example.PNG")} alt="example of laggy instance in the project" className="split-right"></img>
                ...
                <p className="article">An example of the kind of scripting typical to this project. Here, cutscene code is shown, with a cutscene library imported at the top. The pannel on the right side shows a list of built-in functions that are not imported from a library explicitly.</p>
                <h2 className="heading article">Results</h2>
                <h2 className="article">All in all, I made a project that I can still be proud of today with almost an hour of main-plot gameplay. That includes 62 custom areas, 146 dialogue sequences, over 900 scripts (some generated and modified), and countless other customized items and characters. I feel that these large numbers are not just a testament to my efforts in this project, but the speed at which this tool allowed me to develop. It is seriously an excellent tool for teaching beginning programmers how to develop games, and it does not dumb down the process engough that students won't really know what theu're getting into. I'm so glad that I found this game and this tool as this project was one of the primary factors in why I chose my major of computer science, and its why I'm so passionate about game design today.</h2>
