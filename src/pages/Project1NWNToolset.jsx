    ...
    render() {
        return (
            ...
            <div className="content-wrapper">
                ...
                <h2 className="article">My exploration into game design began with this project, though I had been experimenting in other games like Minecaraft previously. Because this was my high school capstone, I was required to provide an outline and a plan on what I would do. When looking for tutorials, I stumbled across the YouTube channel (<a href="https://www.youtube.com/channel/UCsQglNCu3peRlSJF7fsx1DQ" className="link article">Mr. Hanson Videos</a>) for a high school professor's introduction to game design course, which had a playlist of highly relevant tutorials for the tool. The tutorials went over the basic opertions of the toolset and then scraped the surface of the scripting language. Looking back, you could consider this the first game engine I ever worked with.</h2>
                <h2 className="heading article">Making an Interseting and Immersive Game</h2>
                <h2 className="article">After working through the tutorials, it was time to start (world) building. I already had an idea of what I wanted, but I need to brainstorm the storyline a bit more. I began the project before I had finished brainstorming, as there were parts of the story that I knew would not change. From there, I used the art style of the game and assessed my capabilities within the toolset to determine where the story should & could go. One issue I had with the original game developers' stories for the game was that they did not push the game to its limit, and often had only a few entites on screen at the same time. Large scale battles were obviously not an option, but I soon learned the limitations of the program and the game as I added more characters with high level (and therefore visually intensive) abilities.</h2>
                <h2 className="article">I started with the "home" city that so many RPGs have, and quickly fell in love with the instant world-building that came along with the toolset. I was able to create a detailed trade hub city that I called Fendport using built in AI and custom dialogues. A docks area, town square, town hall, and city walls were soon created, all with fleshed out, custom characters that could sell players items and direct them to quests. I found the music and sound customizations to be the most fun to customize. I am huge fan of game soundtracks, especially Neverwinter Nights'. I hold the opinion that the right music and sounds is the most essential part of creating an immersive experience, so I put lots of effort into picking the right music for the areas I created. All this detail allowed for an immersive world that I could not have created on my own at the time.</h2>
                <h2 className="heading article">Embracing Game Development</h2>
                <h2 className="article">Creating a story and a world is great, but the true power in games comes from their reactive nature. Story-based games have a tendancy to balloon into massive projects with numerous possible outcomes. If this ballooning was embraced, these kinds of projects would never make it to production, or would be developed so long that its platform becomes obsolete. With this and my capstone's deadline in mind, I had to figure out a way to give the player the "illusion of choice" that so many RPGs use. This can mainly be found in the dialogue of my story, but after turning in the capstone and deciding to pursue the project further, I decided to create side-quests.</h2>
                <h2 className="article">As for the scripting, I found that I quickly mastered the basics and moved on to more advanced topics like cutscenes. When I first began looking into cutscenes, I was fairly confused, as I had thought that I knew everything that the scripts of the toolset could do (a common misconseption that I found myself reckognizing in the future). Unfortunately, my previous tutorials had no mention of the cutscene system in the toolset, and I had to dig considerably into very old wikis and even older documentation. This was the primary struggle I faced during this project, and after breaking through this issue the rest of the project continued fairly smoothly (unless that is, I wanted to do something more complicated or experimental). As it turns out, the cutscene system wasn't a system at all, but a library full of very hacky, and sometimes unreliable code that could very easily force the player to reload their latest save. I personally love hacky solutions to hard problems, and they remind me of my past attempts to bend games like Minecraft to my will.</h2>
                <h2 className="heading article">Results</h2>
                <h2 className="article">All in all, I made a project that I can still be proud of today with almost an hour of main-plot gameplay. That includes 62 custom areas, 146 dialogue sequences, over 900 scripts (some generated and modified), and countless other customized items and characters. I feel that these large numbers are not just a testament to my efforts in this project, but the speed at which this tool allowed me to develop. It is seriously an excellent tool for teaching beginning programmers how to develop games, and it does not dumb down the process engough that students won't really know what theu're getting into. I'm so glad that I found this game and this tool as this project was one of the primary factors in why I chose my major of comupter science, and its why I'm so passionate about game design today.</h2>
                <h2 className="article">Below is a .zip file with the contents of the project if you happen to Neverwinter Nights 1 (the 2002 or updated version) installed:</h2>
                <div className="flex-left"><img className="icon inline" src={require("../images/icons/zip.ico")} alt="zip icon"/><p className="article link inline">The Retribution of Scengaul.zip</p></div>
                <h2 className="heading article">Play Testing and Feedback</h2>
                <h2 className="article">Throughout the creation of the project, many of my friends were interested in play testing it, and my brother was essential to the project's success. He often tested aspects of my project in ways I had never considered, breaking and blocking the story. This was my first real experience with how important testing code really was (especially since I had not taken any programming coursees up to this point), and I took those lessons to heart in my future projects.</h2>
                <h2 className="article">The feedback I recieved after "releasing" the project was generally positive. Though I no longer have the exact feedback I recieved, here are some general points that I remember:</h2>
                <ul className="article">
                    ...
                    <li className="article">Impressive project that gives about an hour of gameplay</li>
                </ul>
                ...
                <p className="article inline footer">Last Updated: 6/18/2021</p>
            </div>
            <Footer />
            </>
        );
