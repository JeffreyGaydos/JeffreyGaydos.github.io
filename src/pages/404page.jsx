    ...
    render() {
        return (
            <div className="_404">
                ...
                <h4 className="_404">Try looking through the <Link to="/"><span className="_404">Homepage</span></Link> or take a look at the <Link to="/react/legacy/index.html"><span className="_404">Legacy Website</span></Link></h4>
            </div>
        );
    }
}
