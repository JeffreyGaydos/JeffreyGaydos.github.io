    ...
    render() {
        return (
            <div className="wip-notif">
                <h1 className="wip-notif">This main site is currently under development. Look through my <Link to="../legacy/index.html"><span onClick={this.HideAll} className="_404">Legacy Website</span></Link> for more information.</h1>
